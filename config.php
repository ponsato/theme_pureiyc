...
if ('ltr' === get_string('thisdirection', 'langconfig')) {
    $THEME->sheets = array('moodle','mCustomScrollbar','movil');
} else {
...
$THEME->csspostprocess = 'theme_pureiyc_process_css';
...
$THEME->javascripts = array(
   'jquery-1.12.2.min', 'jquery.mousewheel'
);

$THEME->javascripts_footer = array(
   'jquery.mCustomScrollbar', /*'moodlebootstrap',*/  'dock', 'llamadas'
);
...
/* Comprueba la versión para cargar librerías 

include '../version.php';
if ($release == '2.8.5+ (Build: 20150409)') {
    $THEME->javascripts_footer = array(
        'jquery-1.12.2.min','bootstrap.min', 'dock'
    );
} else {
    $THEME->javascripts_footer = array(
       'moodlebootstrap', 'dock', 'jquery-1.12.2.min', 'jquery.mCustomScrollbar', 'jquery.mousewheel', 'llamadas'
    );
}*/
